 ...
 * 40 1120
 * 20 560
 * Java The Hutts 14725 Copyrighted 2020
 * monitor: 640 x 480
 *YES
 */
...
public class opencvSkystoneDetector extends LinearOpMode {
    ...
    private static float[] leftCheck = {5.5f/8f+offsetX, 2.5f/8f+offsetY};
    private static float[] rightCheck = {7.5f/8f+offsetX, 2.5f/8f+offsetY};
